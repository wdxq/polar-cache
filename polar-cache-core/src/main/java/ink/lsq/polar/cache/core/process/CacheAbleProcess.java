...
package ink.lsq.polar.cache.core.process;
 ...
 */
public interface CacheAbleProcess {

    boolean put(CacheAbleProcessPutMethodParam param);

    Object get(CacheAbleProcessGetMethodParam param);
