...
public class CacheAbleProcessPutMethodParam extends CacheAbleProcessParam {
    ...
    public CacheAbleProcessPutMethodParam(String cacheName, List<Object> methodArgs, Object cacheKey, long expireTime, TimeUnit expireTimeUnit, Object cacheObject) {
